...
public class ServicesController {
  ...
  public String register(@RequestParam(value="scheduleList") String scheduleListJson, 
      @ModelAttribute Service service, BindingResult bindingResult,@RequestParam(value="tags") int[] tagNos, String photo,HttpSession session) {
  ...
  public String update(@RequestParam(value = "no") int serviceNo, Model model,
      HttpSession session) {
