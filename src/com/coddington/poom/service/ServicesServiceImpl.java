...
public class ServicesServiceImpl implements ServicesService {
  ...
  public List<Card> getLikeServiceCard(int likeServiceUserNo) {
    ...
    // 나머지 데이터는 가공해서 넣어줌)
    List<Card> likeServiceCardList =
        servicesDAO.selectLikeServicesByLikeServiceUserNo(likeServiceUserNo);
  ...
  @Override
  public List<Card> getContractServiceCardList(int contractStatus, String contractType,
      int userNo) {
    // TODO Auto-generated method stub
  ...
  public Map<String, Object> getContractList(int contractStatus, int cardNo, int userNo) {
    ...
    for (Contract contract : contractList) {
      List<ContractSchedule> contractScheduleList =
          contractSchedulesDAO.selectScheduleListByContractNo(contract.getNo());
      System.out
          .println(String.format("contractScheduleList.size:%d", contractScheduleList.size()));
  ...
  public boolean updateScoreFromTaker(Contract contract, String reviewContent, int userNo) {
    ...
    // 상대방(giver)쪽에서 평점을 남겼다면 계약 상태 update(완료로)
