...
<div id="header">
	...
	<div id="loginBox" class="on">
		...
		<a href="/servie/registerForm.poom">품 요청/등록</a> <a href="/profile.poom">내프로필</a> <a
			href="" class="mypage"> <img src="/img/profile/${loginUser.photoUrl }"
			class="profile" onerror="this.src='/img/profile/profile_img.png'" />
			<span>${loginUser.nickName }<i
